...
$favicon_path = 'image/fmadda.png'; // Default
...
<nav class="navbar navbar-expand-lg custom-navbar">
    <div class="container">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="student/login.php" class="btn btn-outline-dark rounded-pill px-3 py-1 d-lg-none fw-bold small" style="font-size: 0.85rem;">Login</a>
    ...
    <div class="container text-center">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="step-card p-4 text-start">
                    <div class="step-number text-center" style="color: rgba(243, 142, 62, 0.2);">02</div> <!-- Watermark Orange -->
